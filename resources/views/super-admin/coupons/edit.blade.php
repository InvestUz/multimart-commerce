...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Edit coupon details</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('super-admin.coupons.update', $coupon) }}">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" 
                           name="start_date" 
                           value="{{ old('start_date', $coupon->starts_at?->format('Y-m-d')) }}" 
                           required
                ...
                <div>
                    ...
                    <input type="date" 
                           name="end_date" 
                           value="{{ old('end_date', $coupon->expires_at?->format('Y-m-d')) }}" 
                           required

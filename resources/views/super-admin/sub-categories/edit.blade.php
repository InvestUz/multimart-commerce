...
@section('title', 'Edit Sub-Category - Admin Panel')
...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Update sub-category details</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('super-admin.sub-categories.update', $subCategory) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mt-6">
                ...
                <textarea name="description" 
                          ...
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $subCategory->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>

    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div class="container mx-auto px-4 py-16">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-xl text-blue-100">We're here to help and answer any question you might have</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="mb-6">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:support@multimart.com" class="text-gray-600 hover:text-blue-600">
                        ...
                        <div class="mb-6">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+998901234567" class="text-gray-600 hover:text-blue-600">
                                        +998 90 123 45 67
                                    </a>
                                </div>
                            </div>

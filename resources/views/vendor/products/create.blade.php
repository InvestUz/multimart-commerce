        ...
        <form action="{{ route('vendor.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="sub_category_id" id="sub_category_id" required
                                    ...
                                    @if (old('category_id'))
                                        @foreach ($categories->find(old('category_id'))->subCategories ?? [] as $subCategory)
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <p class="text-sm text-gray-600 mb-4">Upload up to 10 images. First image will be the primary image.
                    </p>

                    <div>
                        <label
                            class="block w-full border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:border-primary transition">
                            <i class="fas fa-cloud-upload-alt text-4xl text-gray-400 mb-2"></i>
                            <p class="text-gray-600">Click to upload images</p>
                            <p class="text-sm text-gray-500">PNG, JPG, GIF up to 2MB each</p>
                            <input type="file" name="images[]" multiple accept="image/*" required class="hidden"
                                id="imageInput" onchange="previewImages(event)">
                        </label>
                        @error('images')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="flex gap-4">
                    <button type="submit"
                        class="flex-1 bg-primary text-white py-3 rounded-lg hover:bg-green-600 font-semibold">
                        <i class="fas fa-save mr-2"></i> Create Product
                    </button>
                    <a href="{{ route('vendor.products.index') }}"
                        class="flex-1 border border-gray-300 text-center py-3 rounded-lg hover:bg-gray-50">
                        Cancel
                    </a>
                </div>
            </div>
    ...
    @push('scripts')
        <script>
            ...
            function addSize() {
                ...
                input.name = 'sizes[]';
                input.className =
                    'w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary focus:border-transparent mb-2';

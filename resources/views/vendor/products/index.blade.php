...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                <select name="category" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary focus:border-transparent">
    ...
    @if($products->isEmpty())
        <div class="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <a href="{{ route('vendor.products.create') }}" class="bg-primary text-white px-6 py-3 rounded-lg inline-block hover:bg-green-600">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @if($product->old_price)
                                <p class="text-xs text-gray-500 line-through">${{ number_format($product->old_price, 2) }}</p>
                            @endif
                        </td>
                        <td class="px-6 py-4">
